...
Config.UseWMServerSirens = false -- https://github.com/Walsheyy/WMServerSirens (This is still being worked on, works client sided but others players cannot hear the sirens)
